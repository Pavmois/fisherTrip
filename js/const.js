...
const questions = [
    ...
    [
        ...
        ["Это слишком подозрительно, догоню и попрошу предьявить документы!", "Двинусь навстречу, необходимо узнать от чего он бежит.", "Постараюсь бежать быстрее него и желательно дальше"],
        [
    ...
    [
        ...
        ["Нет, но я уже собираю бригаду товарищей для оцепления опасного места", "Только то, что я из него и пришёл!", "Ненавижу, бля*ь, порталы!"],
        [
    ...
    [
        ...
        ["Зарубить его топором!", "Проверить документы и отправить в тюрьму!", "Напугать и заставить вернуть всё с процентами", "Сочувственно пожать эту руку, ведь Ваши карманы и так пусты.."],
        [
            "this.score.ork++; this.score.witcher--; this.score.got--", 
    ...
    [
        "У вас есть имя?",
        ["Конечно, просто я его забыл", "Нет, у меня слишком ленивые родители"],
        [
            "this.score.got++", 
            "this.score.got--"
        ]
    ...
    [
        "Вы обнаружили огромный, каменный жернов на улице",
        ["Попытаюсь поднять его", "Распоряжусь убрать препятствие с улицы", "Буду готовиться к встрече с троллем, что обронил своё кольцо"],
        [
    ...
    [
        ...
        ["Нет, до последнего буду держать нейтралитет", "С первых секунд выберу сторону и буду освобождать от врага города и форпосты"],
        [
            "this.score.witcher++; this.score.got--", 
            "this.score.got++; this.score.witcher--"
        ]
...
const results = {
    ...
    'simple': {
        ...
        quote1: "- Да тут неглубоко, смотри чё могу!",
        quote2: "",
